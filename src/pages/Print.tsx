...
import { useVehiclesByIds } from "../lib/vehicles"
...
export function Print() {
  ...
  const { data: vehicles, isLoading } = useVehiclesByIds(ids)
  const list = vehicles ?? []
  ...
  return (
    <div className="min-h-screen bg-white p-10">
      <div className="no-print mb-8 flex items-center justify-between">
        <h1 className="font-display text-lg font-semibold text-ink">Print stickers · {list.length}</h1>
